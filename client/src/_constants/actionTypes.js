...
export const adminConstants = {
  ...
  DELETE_BRANCH__REQUEST: "ADMIN_DELETE_BRANCH_REQUEST",
  DELETE_BRANCH__SUCCESS: "ADMIN_DELETE_BRANCH_SUCCESS",
  DELETE_BRANCH__FAILURE: "ADMIN_DELETE_BRANCH_FAILURE",

  UPDATE_BRANCH__REQUEST: "ADMIN_UPDATE_BRANCH_REQUEST",
  UPDATE_BRANCH__SUCCESS: "ADMIN_UPDATE_BRANCH_SUCCESS",
  UPDATE_BRANCH__FAILURE: "ADMIN_UPDATE_BRANCH_FAILURE",

  VIEW_DESIGNATION_REQUEST: "ADMIN_VIEW_BRANCHES_REQUEST",
  VIEW_DESIGNATION_SUCCESS: "ADMIN_VIEW_BRANCHES_SUCCESS",
  VIEW_DESIGNATION_FALIURE: "ADMIN_VIEW_BRANCHES_FALIURE",

  ADD_DESIGNATION_REQUEST: "ADMIN_ADD_BRANCH_REQUEST",
  ADD_DESIGNATION_SUCCESS: "ADMIN_ADD_BRANCH_SUCCESS",
  ADD_DESIGNATION_FALIURE: "ADMIN_ADD_BRANCH_FALIURE",

  DELETE_DESIGNATION__REQUEST: "ADMIN_DELETE_BRANCH_REQUEST",
  DELETE_DESIGNATION__SUCCESS: "ADMIN_DELETE_BRANCH_SUCCESS",
  DELETE_DESIGNATION__FAILURE: "ADMIN_DELETE_BRANCH_FAILURE",

  UPDATE_DESIGNATION__REQUEST: "ADMIN_UPDATE_BRANCH_REQUEST",
  UPDATE_DESIGNATION__SUCCESS: "ADMIN_UPDATE_BRANCH_SUCCESS",
  UPDATE_DESIGNATION__FAILURE: "ADMIN_UPDATE_BRANCH_FAILURE",
  ...
  DELETE_SOURCE__REQUEST: "ADMIN_DELETE_SOURCE_REQUEST",
  DELETE_SOURCE__SUCCESS: "ADMIN_DELETE_SOURCE_SUCCESS",
  DELETE_SOURCE__FAILURE: "ADMIN_DELETE_SOURCE_FAILURE",

  UPDATE_SOURCE__REQUEST: "ADMIN_UPDATE_SOURCE_REQUEST",
  UPDATE_SOURCE__SUCCESS: "ADMIN_UPDATE_SOURCE_SUCCESS",
  UPDATE_SOURCE__FAILURE: "ADMIN_UPDATE_SOURCE_FAILURE",
  ...
  DELETE_BRAND__REQUEST: "ADMIN_DELETE_BRAND_REQUEST",
  DELETE_BRAND__SUCCESS: "ADMIN_DELETE_BRAND_SUCCESS",
  DELETE_BRAND__FAILURE: "ADMIN_DELETE_BRAND_FAILURE",

  UPDATE_BRAND__REQUEST: "ADMIN_UPDATE_BRAND_REQUEST",
  UPDATE_BRAND__SUCCESS: "ADMIN_UPDATE_BRAND_SUCCESS",
  UPDATE_BRAND__FAILURE: "ADMIN_UPDATE_BRAND_FAILURE",
};
